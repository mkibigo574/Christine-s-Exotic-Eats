...
function Hero() {
  return (
    <section className="mesh-hero relative overflow-hidden grain ribbon">
      <div className="mx-auto max-w-6xl px-5 sm:px-6 pt-12 md:pt-28 pb-16 md:pb-28 grid gap-10 md:gap-14 md:grid-cols-[1.1fr_1fr] items-center relative">
        <div className="fade-up relative">
          ...
          <p className="mt-5 md:mt-7 max-w-xl text-base md:text-lg text-[color:rgba(247,241,230,0.85)] leading-relaxed">
...
function HeroVisual() {
  return (
    <div className="relative h-[420px] sm:h-[500px] md:h-[620px]">
      <div className="absolute inset-x-2 sm:inset-x-6 top-0 bottom-12 rounded-[1.5rem] sm:rounded-[2rem] border border-[rgba(216,183,116,0.40)] overflow-hidden shadow-[var(--shadow-deep)]">
        <Image
          src="/hero-spread.jpg"
          alt="A lavish spread of Christine's catering — fruit, grazing, samosas, spring rolls, pastries and wings"
          fill
...
function Pillars() {
  ...
  return (
    <section className="band-warm relative grain-light">
      <div className="mx-auto max-w-6xl px-5 sm:px-6 py-16 md:py-24 relative">
...
function Featured({ featured }: { featured: Category[] }) {
  return (
    <section className="mx-auto max-w-6xl px-5 sm:px-6 py-16 md:py-24">
      <div className="flex items-end justify-between gap-4 md:gap-6 mb-8 md:mb-12">
        <div>
...
function ReviewStrip({ review: r }: { review: Review | undefined }) {
  ...
  return (
    <section className="band-sage relative grain-light">
      <div className="mx-auto max-w-5xl px-5 sm:px-6 py-16 md:py-24 text-center relative">
...
function MeetChristine() {
  return (
    <section className="band-warm relative grain-light">
      <div className="mx-auto max-w-6xl px-5 sm:px-6 py-16 md:py-24 relative">
        <div className="mb-8 md:mb-12 text-center">
          <span className="text-overline">Meet the owner</span>
          <h2 className="mt-2 font-display heading-md font-semibold text-[var(--color-wine-deep)]">
            Hello, I&rsquo;m Christine.
          </h2>
          <div className="mt-5">
            <Ornament />
          </div>
        ...
        <div className="grid gap-8 md:gap-12 md:grid-cols-[0.9fr_1.1fr] items-center">
          <div className="relative">
            <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden border border-[rgba(216,183,116,0.45)] shadow-[var(--shadow-deep)]">
              <Image
                src="/christine.jpg"
                alt="Christine, owner and chef of Christine's Exotic Eats"
                fill
            ...
            <div className="absolute -bottom-5 -right-4 hidden md:flex items-center gap-3 rounded-full bg-[var(--color-paper)] border border-[var(--color-line)] px-4 py-2 shadow-[var(--shadow-soft)]">
              <Monogram size={26} />
              <span className="font-accent italic text-base text-[var(--color-wine-dark)]">
                Finance pro, turned chef.
              </span>
            </div>
          </div>

          <div className="font-display text-base md:text-lg leading-[1.8] md:leading-[1.85] text-[var(--color-ink)] space-y-4 md:space-y-5">
            <p>Thank you for visiting my business.</p>
            <p>
              Christine is my name and I&rsquo;m a Finance Professional, turned
              Chef.
            </p>
            <p>
              As you can already tell, food is my passion and I pinch myself
              each day, to confirm that this is my life now and I love it!
            </p>
            <p>
              I started this business as a side-hustle in December 2018 and now
              run my catering business full-time, since December 2021. I fill
              all the necessary roles; I&rsquo;m the cook, delivery driver,
              receptionist, finance officer, financial analyst, marketing
              &amp; sales manager, HR manager, as well as the public relations
              manager.
            </p>
            <p>
              Please be patient with me, if responses take longer to receive
              than you expect, as I&rsquo;m most definitely tied up with one
              role or the other. I promise to get back to you.
            </p>
            <p>
              I intend to keep the love for this passion going, for as long as
              I possibly can.
            </p>
            <p className="font-accent italic text-2xl text-[var(--color-wine)]">
              I look forward to serving you nothing but delicious food!
            </p>
          </div>
        </div>
      </div>
...
function CallToInquire() {
  return (
    <section className="mx-auto max-w-6xl px-5 sm:px-6 py-16 md:py-24">
      <div className="relative overflow-hidden rounded-[1.5rem] sm:rounded-[2rem] mesh-deep-wine grain px-6 sm:px-8 md:px-16 py-10 sm:py-14 md:py-20 grid md:grid-cols-[1.5fr_1fr] gap-8 md:gap-10 items-center">
        ...
        <div className="relative">
          ...
          <p className="mt-4 text-[color:rgba(247,241,230,0.85)] max-w-xl leading-relaxed">
            Send an enquiry with your event details. We confirm availability
